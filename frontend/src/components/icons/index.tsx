...
// All icons accept optional className prop for customization
// Classes are merged with base size classes to prevent sizing issues

interface IconProps {
  className?: string;
}

// Helper to merge base size with additional classes
function cn(base: string, additional?: string): string {
  if (!additional) return base;
  // If additional includes size classes (w- or h-), use additional only
  if (/\bw-\d|h-\d/.test(additional)) return additional;
...
export function ConfigIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function CameraIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-6 h-6 text-zinc-400 transition-colors", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function ClockIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-4 h-4 text-zinc-400", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
  );
}
...
export function HelpIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-4 h-4 text-zinc-500 hover:text-zinc-300 cursor-help", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function ResultsIcon({ className }: IconProps) {
  return (
    <svg className={cn("w-8 h-8 text-zinc-500", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
    </svg>
  );
}

export function ResearchIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function SimulatorIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
